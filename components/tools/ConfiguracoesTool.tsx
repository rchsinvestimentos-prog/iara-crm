...
export default function ConfiguracoesTool() {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* ============ 3. CONEXÕES (Link para Instâncias) ============ */}
            <div className="backdrop-blur-xl rounded-2xl p-5" style={cardStyle}>
                ...
                <p className="text-[10px] mb-4" style={{ color: 'var(--text-muted)' }}>
                    WhatsApp, Instagram, Google Calendar e outros sistemas são gerenciados na página de Instâncias.
                </p>
                <a
                    href="/instancias"
                    className="flex items-center justify-between p-4 rounded-xl transition-colors hover:opacity-80"
                    style={{ backgroundColor: 'var(--bg-subtle)', border: '1px solid var(--border-default)', textDecoration: 'none' }}
                >
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-[12px] font-semibold" style={{ color: 'var(--text-primary)' }}>Gerenciar Conexões</p>
                            <p className="text-[10px]" style={{ color: 'var(--text-muted)' }}>WhatsApp · Instagram · Google Calendar</p>
                        </div>
                    </div>
                    <span className="text-[11px] font-medium px-4 py-2 rounded-lg" style={{ backgroundColor: '#0F4C61', color: 'white' }}>
                        Abrir →
                    </span>
                </a>
            </div>
