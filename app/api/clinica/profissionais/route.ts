...
export async function POST(req: NextRequest) {
    ...
    const profissional = await prisma.profissional.create({
        data: {
            ...
            linkAgendamento: body.linkAgendamento || null,
            fotoUrl: body.fotoUrl || null,
            chavePix: body.chavePix || null,
            linkPagamento: body.linkPagamento || null,
...
export async function PUT(req: NextRequest) {
    ...
    const updated = await prisma.profissional.update({
        ...
        data: {
            ...
            ...(body.tratamento !== undefined && { tratamento: body.tratamento }),
            ...
            ...(body.cursos !== undefined && { cursos: body.cursos }),
            ...(body.redesSociais !== undefined && { redesSociais: body.redesSociais }),
            ...
            ...(body.linkAgendamento !== undefined && { linkAgendamento: body.linkAgendamento || null }),
            ...(body.fotoUrl !== undefined && { fotoUrl: body.fotoUrl }),
            ...(body.chavePix !== undefined && { chavePix: body.chavePix }),
            ...(body.linkPagamento !== undefined && { linkPagamento: body.linkPagamento }),
